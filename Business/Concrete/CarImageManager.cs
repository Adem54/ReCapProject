...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        {
            return new SuccessDataResult<CarImage>(_carImageDal.Get(c => c.Id == imageId), ImageConstants.ImageGettedById);
        }

        public IResult Update(IFormFile file, CarImage carImage)
        {
            IResult result = BusinessRules.Run(CheckIfCarLimitedExceded(carImage.CarId));
            if (result != null)
            {
                return result;
            }
            ...
            var oldPath = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory,
                     "..\\..\\..\\wwwroot")) + _carImageDal.Get(p => p.Id == carImage.Id).ImagePath;
        ...
        public IDataResult<List<CarImage>> GetImagesByCarId(int carId)
        {
            ...
            return new SuccessDataResult<List<CarImage>>(CheckIfCarImageNull(carId).Data,
                ImageConstants.ImageGettedByCarId);

        }


        private IResult CheckIfCarLimitedExceded(int carId)
        {
        ...
        private IDataResult<List<CarImage>> CheckIfCarImageNull(int id)
        {
            ...
            try
            {
                string path = @"uploads\carRentalLogo.jpg";
